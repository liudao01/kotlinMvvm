...
public class AlertView {
    ...
    protected void initListView() {
        ...
        if (cancel != null && style == Style.Alert) {
            ...
            tvAlert.setTextColor(context.getResources().getColor(R.color.textColor_alert_button_cancel_gray));
...
//        contentContainer.startAnimation(outAnim);
    ...
    /**
     * Called when the user touch on black com.sinochem.www.car.owner.overlay in order to dismiss the dialog
     */
