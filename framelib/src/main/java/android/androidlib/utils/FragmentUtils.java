...
public final class FragmentUtils {
     ...
     */
    public static  <F extends Fragment> void add(@NonNull final FragmentManager fm,
                           @NonNull final F add,
                           @IdRes final int containerId) {
        add(fm, add, containerId, null, false, false);
    }

    public static <T extends Fragment> void add2(@NonNull final FragmentManager fm,
                                                 @NonNull final T add,
                                                 @IdRes final int containerId) {
        add(fm, add, containerId, null, false, false);
    }
    ...
    public static void add2(@NonNull final FragmentManager fm,
                           @NonNull final List<Fragment> adds,
                           @IdRes final int containerId,
                           final String[] tags,
                           final int showIndex) {
